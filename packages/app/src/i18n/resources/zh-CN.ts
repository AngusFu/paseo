...
export const zhCN: TranslationResources = {
  ...
  knowledgeBases: {
    ...
    emptyCatalogHint: "请到 Host → 知识库 导入。",
  ...
  settings: {
    ...
    hostSections: {
      ...
      knowledgeBases: {
        ...
        unsupported: "更新 Host 以使用 Knowledge bases。",
        connecting: "连接中…",
        loading: "正在加载 Knowledge bases…",
        emptyTitle: "还没有 Knowledge base",
        emptyHint: "导入文本文件夹或语料包。一次性导入 — 不会监视磁盘路径。",
