...
export const ar: TranslationResources = {
  ...
  sessions: {
    ...
    searchEmpty: {
      ...
      onlyLoaded: "يتم البحث فقط ضمن {{count}} جلسة محمّلة حتى الآن",
    },
    actions: {
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      search: {
        ...
        accessibilityLabel: "البحث في الملفات",
        searching: "جارٍ البحث…",
    ...
    git: {
      ...
      diff: {
        ...
        contextExpandUp: "التوسيع للأعلى",
        contextExpandDown: "التوسيع للأسفل",
        contextExpandAll: "توسيع كل الأسطر المخفية",
        contextHiddenLine: "{{count}} سطر مخفي",
        contextHiddenLines: "{{count}} سطر مخفي",
        contextExpandMore: "عرض المزيد من الأسطر",
        contextExpandFailed: "تعذر تحميل مزيد من السياق.",
        refreshing: "منعش",
        refresh: "ينعش",
        ...
        worktreeMissing: "لم تعد شجرة عمل مساحة العمل هذه موجودة.",
        worktreeMissingArchiveAction: "أرشفة مساحة العمل",
        worktreeMissingArchiveFailed: "فشل أرشفة مساحة العمل.",
        diffMode: "وضع الفرق",
        uncommitted: "غير ملتزم",
        committed: "ملتزم",
        branchUnknown: "مجهول",
        base: "قاعدة",
        baseReselectAction: "اختر فرعًا أساسيًا…",
        baseReselectTitle: "اختيار الفرع الأساسي",
        baseReselectFailed: "تعذّر تعيين الفرع الأساسي.",
        newFile: "جديد",
        ...
        algorithmHistogram: "الرسم البياني",
        algorithmMyers: "Myers",
        algorithmPatience: "الصبر",
        installDifftastic: "تثبيت difftastic…",
        installingDifftastic: "جارٍ تثبيت difftastic…",
        difftasticUnavailable: "difftastic غير متاح على هذا الخادم",
        lineDiffBadge: "مقارنة أسطر",
        compareWithBranch: "المقارنة مع فرع…",
        branchCompareTitle: "المقارنة مع فرع",
        comparingWithBranch: "مقابل {{branch}}",
        compareAgainstRef: "المقارنة مقابل…",
        swapRefs: "تبديل",
        onlyChangesOnBranch: "التغييرات في هذا الفرع فقط",
        fullDiff: "مقارنة كاملة",
        textSize: "حجم النص",
        textSizeXs: "صغير جدًا",
        textSizeSm: "صغير",
        textSizeMd: "متوسط",
        textSizeLg: "كبير",
        textSizeXl: "كبير جدًا",
        textSizeXxl: "ضخم",
        textSizeXxxl: "عملاق",
        commits: {
          title: "الإيداعات",
  ...
  settings: {
    ...
    host: {
      ...
      voiceTts: {
        title: "نموذج TTS الصوتي",
        hint: "تحويل النص إلى كلام لوضع الصوت. Kokoro متعدد اللغات يدعم الصينية والإنجليزية",
        loading: "جارٍ تحميل النماذج…",
        notInstalled: "لم يُنزَّل بعد",
        downloading: "جارٍ التنزيل…",
        downloadingPercent: "جارٍ التنزيل {{percent}}%",
        downloadingPercentWithSpeed: "جارٍ التنزيل {{percent}}% · {{speed}}",
        downloadSpeed: "{{speed}}",
        ...
        available: "متاح",
        unsupported: "حدّث المضيف لاستخدام هذه الميزة.",
        loadError: "تعذّر تحميل نماذج TTS الصوتي.",
        cloudProviderHint:
          "TTS الصوتي يستخدم حاليًا {{provider}}. تطبيق نموذج أدناه يعيد TTS إلى المحلي.",
        languagesMany: "{{count}} لغة",
        models: {
          kokoroEn: "Kokoro (إنجليزي)",
          kokoroMultiLang: "Kokoro (صيني + إنجليزي)",
        },
        selectErrorTitle: "تعذّر تبديل نموذج TTS الصوتي",
      },
      workspaces: {
  ...
  kanban: {
    ...
    columnForm: {
      ...
      titleLabel: "اسم العمود",
      titlePlaceholder: "اسم العمود",
    ...
    columnDelete: {
      title: "حذف العمود",
      message: 'حذف "{{title}}"؟ اختر إلى أين تنتقل بطاقاته.',
      destinationLabel: "نقل البطاقات إلى",
      confirm: "حذف",
    },
    hiddenColumns: {
      entry: "الأعمدة المخفية",
      title: "الأعمدة المخفية",
      empty: "لا توجد أعمدة مخفية",
      restore: "استعادة",
    },
    theme: {
      none: "افتراضي",
    ...
    sources: {
      manageTitle: "المصادر والاتصالات",
    ...
    sourceForm: {
      statusMapping: {
        title: "ربط الحالات",
        createHint: "احفظ المصدر لتهيئة ربط الحالات.",
        projectKey: "مفتاح المشروع",
        projectKeyPlaceholder: "مثال: SCIF",
        loadButton: "تحميل الحالات",
        loading: "جارٍ تحميل الحالات…",
        loadError: "تعذّر تحميل الحالات.",
        columnsLoadError: "تعذّر تحميل الأعمدة.",
        empty: "لم يتم العثور على حالات.",
        columnLabel: "العمود",
        columnPlaceholder: "اختر العمود",
        autoOption: "تلقائي (حسب الفئة)",
      },
      ...
      gitlab: "GitLab",
      name: "الاسم",
      namePlaceholder: "لوحتي",
      query: "الاستعلام",
      queryPlaceholder: "JQL أو مرشح MR",
      connection: "الاتصال",
      connectionHint: "اتصال Jira/GitLab المستخدم للمصادقة.",
      connectionNone: "بدون",
      baseUrl: "تجاوز عنوان URL الأساسي",
      baseUrlHint: "اختياري. الافتراضي هو عنوان URL الأساسي للاتصال.",
    ...
    connections: {
      ...
      connectJira: "ربط Jira",
      connectGitlab: "ربط GitLab",
      delete: "حذف",
      confirmDelete: 'حذف "{{name}}"؟ لا يمكن التراجع عن ذلك.',
    },
    workflowRules: {
    ...
    connectionForm: {
      ...
      baseUrlPlaceholder: "https://your-instance.example.com",
      token: "رمز الوصول",
      tokenPlaceholder: "الصق رمز وصول شخصي",
      oauthClientId: "معرّف عميل OAuth",
      oauthClientSecret: "سر عميل OAuth",
      authHint: "الصق رمز وصول، أو سجّل تطبيق OAuth واستخدم ربط.",
      connectHint: "احفظ الاتصال ثم أعد فتحه للربط.",
      save: "حفظ",
      create: "إنشاء",
    },
    ...
    cardDetail: {
      ...
      loadError: "تعذّر تحميل تفاصيل البطاقة",
      unsupported: "حدّث المضيف لعرض تفاصيل البطاقة الكاملة.",
      assignee: "المكلّف",
      reporter: "المُبلّغ",
      priority: "الأولوية",
      created: "أُنشئت",
      ...
      loadCommentsWithCount: "تحميل التعليقات ({{count}})",
      commentsLoadError: "تعذّر تحميل التعليقات",
      unknownAuthor: "غير معروف",
      dispatch: "التنفيذ عبر CLI",
      dispatchWorkspaceLabel: "مساحة العمل",
      dispatchWorkspacePlaceholder: "اختر مساحة العمل",
      dispatchNoWorkspaces: "لا توجد مساحات عمل متاحة — أضف واحدة لتضمين --cwd.",
      dispatchPromptLabel: "الطلب",
      dispatchRun: "تشغيل",
      dispatchRunNoWorkspace: "اختر مشروعًا لتنفيذ وكيل.",
      dispatchRunNoProvider: "لا يوجد مزوّد متاح",
      dispatchRunConfirmTitle: "تشغيل الوكيل؟",
      dispatchRunConfirmProject: "المشروع",
      dispatchRunConfirmWorktree: "شجرة العمل",
      dispatchRunConfirmProvider: "المزوّد",
  ...
  workflows: {
    ...
    workspaceTargetNew: "مساحة عمل جديدة",
    workspaceTargetExisting: "مساحة عمل موجودة",
    workspaceTarget: "مساحة العمل",
    workspacePickerPlaceholder: "اختر مساحة عمل",
    workspacePickerEmpty: "لا توجد مساحات عمل على هذا المضيف بعد",
    browseCwd: "Browse",
  ...
  schedule: {
    ...
    filter: { active: "نشطة", ended: "منتهية" },
    list: {
      loadError: "تعذّر تحميل الجداول",
      tryAgain: "إعادة المحاولة",
      hostError: "{{serverName}}: تعذّر تحميل الجداول",
      newSchedule: "جدول جديد",
    },
    empty: {
      activeTitle: "لا توجد جداول نشطة",
      activeDescription: "تُشغّل الجداول الوكلاء وفق وتيرة محددة.",
      seeDocs: "عرض الوثائق",
      endedTitle: "لا توجد جداول منتهية",
    },
    form: {
      createTitle: "جدول جديد",
      ...
      name: {
        label: "الاسم",
        placeholder: "اختياري",
        accessibility: "اسم الجدول",
      },
      prompt: {
        label: "الطلب",
        placeholder: "ما الذي ينبغي أن يفعله الوكيل في كل تشغيل؟",
      },
      maxRuns: {
        label: "الحد الأقصى للتشغيلات",
        placeholder: "بلا حد",
      },
      host: {
        label: "المضيف",
        placeholder: "اختر مضيفًا",
        empty: "لم يُعثر على مضيفين",
      },
      project: {
        label: "المشروع",
        placeholder: "اختر مشروعًا",
        empty: "لم يُعثر على مشاريع",
      ...
      mode: {
        ...
        empty: "لم يُعثر على أوضاع",
        unavailable: "لا تتوفر أوضاع لهذا النموذج.",
      },
      isolation: {
        label: "العزل",
        placeholder: "اختر نوع العزل",
        empty: "لم يُعثر على خيارات عزل",
        local: "محلي",
        worktree: "شجرة عمل",
      },
      archiveOnFinish: "الأرشفة عند الانتهاء",
    },
    cadence: {
      label: "الوتيرة",
      placeholder: "اختر الوتيرة",
      empty: "لم يُعثر على وتيرات",
      cronAccessibility: "تعبير Cron",
      presets: {
      ...
      every: {
        minuteOne: "كل {{count}} دقيقة",
        minuteMany: "كل {{count}} دقيقة",
        hourOne: "كل {{count}} ساعة",
        hourMany: "كل {{count}} ساعة",
        dayOne: "كل {{count}} يوم",
        dayMany: "كل {{count}} يوم",
      },
      errorRequired: "أدخل تعبير Cron",
    },
    meta: {
      untitledSchedule: "جدول بلا عنوان",
      created: "أُنشئ {{time}}",
      lastRun: "آخر تشغيل {{time}}",
      neverRun: "لم يُشغّل قط",
      nextRun: "التشغيل التالي {{next}}",
      nextRunSoon: "قريبًا",
      nextRunMinutes: "خلال {{count}} د",
      nextRunHours: "خلال {{count}} س",
      nextRunDays: "خلال {{count}} ي",
    },
    state: {
      active: "نشط",
      paused: "متوقف مؤقتًا",
      ...
      finished: "مكتمل",
      targetGone: "الهدف غير موجود",
    },
    menu: {
      actions: "إجراءات الجدول",
      editA11y: "تعديل الجدول {{title}}",
      edit: "تعديل الجدول",
      resume: "استئناف الجدول",
