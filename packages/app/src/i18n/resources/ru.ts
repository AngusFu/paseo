...
export const ru: TranslationResources = {
  ...
  kanban: {
    ...
    cardDetail: {
      ...
      summary: "ИИ-сводка",
      summaryGenerating: "Создание сводки…",
      summaryFailed: "Не удалось создать сводку.",
      summaryRegenerate: "Пересоздать сводку",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        download: "Настройте локальный ИИ в параметрах хоста",
