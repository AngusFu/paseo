export const en = {
  ...
  message: {
    actions: {
      ...
      showToolCallDebug: "Show tool call payloads",
      hideToolCallDebug: "Hide tool call payloads",
      showMore: "Show more",
      showLess: "Show less",
    },
    attachments: {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        contextExpandUp: "Expand up",
        contextExpandDown: "Expand down",
        contextExpandAll: "Expand all hidden lines",
        contextHiddenLine: "{{count}} hidden line",
        contextHiddenLines: "{{count}} hidden lines",
        contextExpandMore: "Show more lines",
        contextExpandFailed: "Could not load more context.",
        ...
        worktreeMissing: "This workspace's worktree no longer exists.",
        worktreeMissingArchiveAction: "Archive workspace",
        worktreeMissingArchiveFailed: "Failed to archive workspace.",
        diffMode: "Diff mode",
        uncommitted: "Uncommitted",
        committed: "Committed",
        branchUnknown: "Unknown",
        base: "base",
        baseReselectAction: "Choose a base branch…",
        baseReselectTitle: "Select base branch",
        baseReselectFailed: "Failed to set the base branch.",
        newFile: "New",
        deletedFile: "Deleted",
        engine: "Engine",
        engineGit: "Git",
        ...
        installDifftastic: "Install difftastic…",
        installingDifftastic: "Installing difftastic…",
        difftasticUnavailable: "Difftastic isn't available on this server",
        lineDiffBadge: "line diff",
        compareWithBranch: "Compare with branch…",
        branchCompareTitle: "Compare with branch",
        comparingWithBranch: "vs {{branch}}",
        compareAgainstRef: "Compare against…",
        swapRefs: "Swap",
        onlyChangesOnBranch: "Only changes on this branch",
        fullDiff: "Full diff",
        textSize: "Text size",
  ...
  // Hub + workspace mount surfaces. Manage list/import/export/delete copy also
  // reuses settings.hostSections.knowledgeBases for shared strings.
  knowledgeBases: {
  ...
  settings: {
    ...
    hostSections: {
      ...
      fastmcp: {
        ...
        addHint:
          "HTTP: remote URL (OAuth optional). Stdio: local command MCP. Bearer/headers still unsupported.",
    ...
    host: {
      ...
      voiceTts: {
        title: "Voice TTS model",
        hint: "Text-to-speech for voice mode. Kokoro multilingual covers Chinese and English",
        loading: "Loading models…",
        notInstalled: "Not downloaded yet",
        downloading: "Downloading…",
        downloadingPercent: "Downloading {{percent}}%",
        ...
        available: "Available",
        unsupported: "Update the host to use this.",
        loadError: "Couldn't load voice TTS models.",
        cloudProviderHint:
          "Voice TTS is currently using {{provider}}. Applying a model below switches TTS back to local.",
        languagesMany: "{{count}} languages",
        models: {
          kokoroEn: "Kokoro (English)",
          kokoroMultiLang: "Kokoro (Chinese + English)",
        },
        selectErrorTitle: "Couldn't switch voice TTS model",
      },
      workspaces: {
  ...
  kanban: {
    ...
    columnDelete: {
      title: "Delete column",
      message: 'Delete "{{title}}"? Choose where its cards go.',
      destinationLabel: "Move cards to",
      confirm: "Delete",
    },
    hiddenColumns: {
      entry: "Hidden columns",
      title: "Hidden columns",
      empty: "No hidden columns",
      restore: "Restore",
    },
    theme: {
      none: "Default",
    ...
    sources: {
      manageTitle: "Sources & connections",
    ...
    sourceForm: {
      statusMapping: {
        ...
        createHint: "Save the source to configure status mapping.",
        projectKey: "Project key",
        projectKeyPlaceholder: "e.g. SCIF",
        loadButton: "Load statuses",
        loading: "Loading statuses...",
        loadError: "Couldn't load statuses.",
        columnsLoadError: "Couldn't load columns.",
        empty: "No statuses found.",
        columnLabel: "Column",
        columnPlaceholder: "Select column",
        autoOption: "Auto (by category)",
      },
      ...
      query: "Query",
      queryPlaceholder: "JQL or MR filter",
      connection: "Connection",
      connectionHint: "The Jira/GitLab connection used to authenticate.",
      connectionNone: "None",
      baseUrl: "Base URL override",
      baseUrlHint: "Optional. Defaults to the connection's base URL.",
    ...
    connectionForm: {
      ...
      authHint: "Paste an access token, or register an OAuth app and use Connect.",
      connectHint: "Save the connection, then reopen it to connect.",
      save: "Save",
      create: "Create",
    },
    ...
    cardDetail: {
      title: "Card details",
      loadError: "Unable to load card details",
      unsupported: "Update the host to see full card details.",
      assignee: "Assignee",
      reporter: "Reporter",
      priority: "Priority",
      created: "Created",
      ...
      loadCommentsWithCount: "Load comments ({{count}})",
      commentsLoadError: "Unable to load comments",
      unknownAuthor: "Unknown",
      dispatch: "Dispatch via CLI",
      dispatchWorkspaceLabel: "Workspace",
      dispatchWorkspacePlaceholder: "Select workspace",
      dispatchNoWorkspaces: "No workspaces available — add one to include --cwd.",
      dispatchPromptLabel: "Prompt",
      dispatchRun: "Run",
      dispatchRunNoWorkspace: "Select a project to dispatch an agent.",
      dispatchRunNoProvider: "No provider available",
      dispatchRunConfirmTitle: "Run agent?",
      dispatchRunConfirmProject: "Project",
      dispatchRunConfirmWorktree: "Worktree",
      dispatchRunConfirmProvider: "Provider",
  ...
  workflows: {
    ...
    workspaceTargetNew: "New workspace",
    workspaceTargetExisting: "Existing workspace",
    workspaceTarget: "Workspace",
    workspacePickerPlaceholder: "Choose a workspace",
    workspacePickerEmpty: "No workspaces on this host yet",
    browseCwd: "Browse",
    ...
    task: "Task",
    taskPlaceholder: "e.g. Fix the login crash and add a regression test",
  ...
  schedule: {
    ...
    list: {
      ...
      tryAgain: "Try again",
      hostError: "{{serverName}}: Could not load schedules",
    ...
    form: {
      ...
      mode: {
        ...
        unavailable: "No modes are available for this model.",
      },
      isolation: {
        label: "Isolation",
        placeholder: "Select isolation",
        empty: "No isolation options found",
        local: "Local",
        worktree: "Worktree",
      },
    ...
    cadence: {
      ...
      every: {
        minuteOne: "Every {{count}} minute",
        minuteMany: "Every {{count}} minutes",
        hourOne: "Every {{count}} hour",
        hourMany: "Every {{count}} hours",
        dayOne: "Every {{count}} day",
        dayMany: "Every {{count}} days",
      },
      errorRequired: "Enter a cron expression",
    },
    meta: {
      ...
      neverRun: "Never run",
      nextRun: "Next run {{next}}",
      nextRunSoon: "soon",
      nextRunMinutes: "in {{count}}m",
      nextRunHours: "in {{count}}h",
      nextRunDays: "in {{count}}d",
    },
    state: {
      active: "Active",
      paused: "Paused",
