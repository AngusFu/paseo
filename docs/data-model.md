...
Local speech model ids are intentionally narrow: STT defaults to `sense-voice-zh-en-ja-ko-yue-int8` when language is Chinese (else `parakeet-tdt-0.6b-v2-int8`), TTS defaults to `kokoro-en-v0_19`, and turn detection uses the bundled Silero VAD model.
