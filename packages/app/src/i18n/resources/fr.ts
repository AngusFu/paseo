...
export const fr: TranslationResources = {
  ...
  message: {
    actions: {
      ...
      showToolCallDebug: "Afficher les charges utiles des appels d'outils",
      hideToolCallDebug: "Masquer les charges utiles des appels d'outils",
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      search: {
        ...
        accessibilityLabel: "Rechercher des fichiers",
        searching: "Recherche…",
    ...
    git: {
      ...
      diff: {
        ...
        contextExpandUp: "Développer vers le haut",
        contextExpandDown: "Développer vers le bas",
        contextExpandAll: "Développer toutes les lignes masquées",
        contextHiddenLine: "{{count}} ligne masquée",
        contextHiddenLines: "{{count}} lignes masquées",
        contextExpandMore: "Afficher plus de lignes",
        contextExpandFailed: "Impossible de charger plus de contexte.",
        ...
        worktreeMissing: "L'arbre de travail de cet espace de travail n'existe plus.",
        worktreeMissingArchiveAction: "Archiver l'espace de travail",
        worktreeMissingArchiveFailed: "Échec de l'archivage de l'espace de travail.",
        diffMode: "Mode différentiel",
        uncommitted: "Non engagé",
        committed: "Engagé",
        branchUnknown: "Inconnu",
        base: "base",
        baseReselectAction: "Choisir une branche de base…",
        baseReselectTitle: "Sélectionner la branche de base",
        baseReselectFailed: "Échec de la définition de la branche de base.",
        newFile: "Nouveau",
  ...
  settings: {
    ...
    host: {
      ...
      voiceTts: {
        title: "Modèle TTS vocal",
        hint: "Synthèse vocale pour le mode vocal. Kokoro multilingue couvre le chinois et l'anglais",
        loading: "Chargement des modèles…",
        notInstalled: "Pas encore téléchargé",
        downloading: "Téléchargement…",
        downloadingPercent: "Téléchargement {{percent}}%",
        ...
        loadError: "Impossible de charger les modèles TTS vocaux.",
        cloudProviderHint:
          "Le TTS vocal utilise actuellement {{provider}}. Appliquer un modèle ci-dessous repasse en local.",
        languagesMany: "{{count}} langues",
        models: {
          kokoroEn: "Kokoro (anglais)",
          kokoroMultiLang: "Kokoro (chinois + anglais)",
        },
        selectErrorTitle: "Impossible de changer le modèle TTS vocal",
      },
      workspaces: {
  ...
  kanban: {
    ...
    sync: {
      succeeded: "{{count}} sources synchronisées",
      failed: "Échec de synchronisation pour {{count}} sources : {{names}}",
    },
    filters: {
      trigger: "Filtres",
    ...
    cardDetail: {
      ...
      status: "Statut",
      replyPlaceholder: "Ajouter un commentaire…",
      replySend: "Envoyer",
    },
    transitions: {
      pick: "Déplacer vers",
      loadError: "Impossible de charger les transitions",
      empty: "Aucune transition disponible",
    },
  },
  workflows: {
    title: "Workflows",
    ...
    workspaceTargetNew: "Nouvel espace de travail",
    workspaceTargetExisting: "Espace de travail existant",
    workspaceTarget: "Espace de travail",
    workspacePickerPlaceholder: "Choisir un espace de travail",
    workspacePickerEmpty: "Aucun espace de travail sur cet hôte",
    browseCwd: "Browse",
