...
export const ru: TranslationResources = {
  ...
  agentControls: {
    ...
    features: {
      ...
      autoAccept: {
        label: "Автоодобрение",
        tooltip: "Как --yolo: постоянно разрешает инструменты без запросов разрешений",
      },
    },
    mode: {
      title: "Режим",
  ...
  sessions: {
    ...
    searchEmpty: {
      title: "Нет подходящих сеансов",
      onlyLoaded: "Поиск выполняется только среди {{count}} уже загруженных сеансов",
    },
    actions: {
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      search: {
        ...
        accessibilityLabel: "Поиск файлов",
        searching: "Поиск…",
        noMatches: "Нет совпадений",
      },
      states: {
    ...
    git: {
      ...
      diff: {
        ...
        loadingHunks: "Loading diff…",
        lazyHunksUnavailable: "Update the host to load this diff.",
        lazyHunksFailed: "Could not load this file's diff.",
        ...
        contextExpandUp: "Развернуть вверх",
        contextExpandDown: "Развернуть вниз",
        contextExpandAll: "Развернуть все скрытые строки",
        contextHiddenLine: "Скрыто строк: {{count}}",
        contextHiddenLines: "Скрыто строк: {{count}}",
        contextExpandMore: "Показать больше строк",
        contextExpandFailed: "Не удалось загрузить больше контекста.",
        ...
        worktreeMissing: "Рабочее дерево этого рабочего пространства больше не существует.",
        worktreeMissingArchiveAction: "Архивировать рабочее пространство",
        worktreeMissingArchiveFailed: "Не удалось архивировать рабочее пространство.",
        diffMode: "Режим разницы",
        uncommitted: "Незафиксированный",
        committed: "Преданный идее",
        branchUnknown: "Неизвестный",
        base: "база",
        baseReselectAction: "Выбрать базовую ветку…",
        baseReselectTitle: "Выбор базовой ветки",
        baseReselectFailed: "Не удалось задать базовую ветку.",
        newFile: "Новый",
        deletedFile: "Удалено",
        engine: "Движок",
        engineGit: "Git",
        ...
        algorithm: "Алгоритм",
        algorithmHistogram: "Гистограмма",
        algorithmMyers: "Myers",
        algorithmPatience: "Patience",
        installDifftastic: "Установить difftastic…",
        installingDifftastic: "Установка difftastic…",
        difftasticUnavailable: "Difftastic недоступен на этом сервере",
        lineDiffBadge: "построчный diff",
        compareWithBranch: "Сравнить с веткой…",
        branchCompareTitle: "Сравнить с веткой",
        comparingWithBranch: "с {{branch}}",
        compareAgainstRef: "Сравнить с…",
        swapRefs: "Поменять местами",
        onlyChangesOnBranch: "Только изменения этой ветки",
  ...
  sidebar: {
    ...
    knowledgeBasesEmpty: {
      title: "No Knowledge base mounts",
      description: "Agents in this workspace see an empty /paseo-vfs.",
      mount: "Mount knowledge bases",
    },
    project: {
      actions: {
    ...
    workspace: {
      ...
      actions: {
        ...
        unpin: "Открепить",
        mountKnowledgeBases: "Mount knowledge bases",
        archive: "Архив",
  ...
  knowledgeBases: {
    ...
    unsupported: "Update the host to use Knowledge bases.",
    noHost: "Add a host to manage Knowledge bases.",
    switchHost: "Switch host",
    newAction: "New knowledge base",
    newTitle: "New knowledge base",
    modeLabel: "Mode",
    modeEmpty: "Empty",
    modeImport: "Import",
    emptyHint: "Creates an empty Knowledge base. Add pages later from the detail screen.",
    createSubmit: "Create",
    creating: "Creating…",
    createOk: "Created {{slug}}",
    createFailed: "Create failed",
    createUnavailable: "Update the host to create an empty Knowledge base.",
    notMounted: "Not mounted",
    detail: {
      emptyTitle: "This Knowledge base has no pages yet",
      emptyBody: "Add a first page to start building this Knowledge base.",
      addFirstPage: "Add first page",
      newPage: "New page",
      editPage: "Edit page",
      pagePath: "Page path",
      pagePathPlaceholder: "index.md",
      markdown: "Markdown",
      markdownPlaceholder: "Write markdown…",
      optionalContent: "Optional initial content",
      save: "Save",
      unsavedHint: "Unsaved changes",
      deletePage: "Delete page",
      deletePageTitle: "Delete page?",
      deletePageMessage: "Delete {{path}}? This cannot be undone.",
      renamePage: "Rename or move",
      renamePageTitle: "Rename or move page",
      renameSubmit: "Move",
      addPageTitle: "New page",
      addPageSubmit: "Create page",
      discardUnsavedTitle: "Unsaved changes",
      discardUnsavedMessage: "Discard unsaved changes?",
      discard: "Discard",
      authoringUnavailable: "Update the host to edit Knowledge base pages.",
      savedToast: "Saved {{path}}",
      createdToast: "Created {{path}}",
      deletedPageToast: "Deleted {{path}}",
      movedToast: "Moved to {{path}}",
      pathInvalid: "Page path must be a .md, .mdx, or .txt path inside the Knowledge base.",
      searchPlaceholder: "Search this Knowledge base",
      searchEmpty: 'No pages matched "{{query}}".',
      searchModeGrep: "Grep",
      searchModeVector: "Vector",
      mountedOn: "Mounted on {{count}} workspace(s)",
      mountsManagedHint:
        "Mounts are managed from workspaces. Open a workspace to add or remove mounts.",
      mountInCurrentWorkspace: "Mount in current workspace",
      openWorkspaceFirstToast: "Open a workspace on this host first, then mount from there.",
      notMountedYet: "Not mounted on any workspace yet.",
      selectPage: "Select a page to preview.",
      notFound: "Knowledge base not found on this host.",
      backToList: "Back to Knowledge bases",
      browseUnavailable: "Loading page browse…",
    },
    mountKnowledgeBases: "Mount knowledge bases",
    optional: "optional",
    mountSlug: "Mount slug",
    mountSlugInvalid:
      "Mount slugs must match a-z, 0-9, hyphens (max 63), and be unique in this selection.",
    pathPreview: "→ /paseo-vfs/{{slug}}",
    emptyCatalog: "No Knowledge bases on this host.",
    emptyCatalogHint: "Create or import one from Knowledge bases.",
    noneSelected: "None selected. Agents will see an empty /paseo-vfs until you mount later.",
    mountsSheet: {
      workspaceLabel: "Workspace: {{name}}",
      mounted: "Mounted",
      empty: "No Knowledge base mounts yet.",
      add: "Add mount",
      addTitle: "Add mount",
      unmount: "Unmount",
      done: "Done",
      slugImmutable: "Mount slugs cannot be renamed. To change a slug, unmount and mount again.",
      knowledgeBase: "Knowledge base",
      agentsSee: "Agents see /paseo-vfs/{{slug}}",
      mount: "Mount",
      noAvailable: "All Knowledge bases are already mounted.",
      unmountConfirmTitle: "Unmount Knowledge base?",
      unmountConfirmRunningMessage:
        "Agents are running in this workspace and will lose /paseo-vfs/{{slug}} immediately.",
      unmountConfirm: "Unmount",
      mountFailed: "Workspace created, but mounting failed: {{error}}",
      mountPartialFailed: "Workspace created, but {{count}} mount(s) failed.",
    },
  },
  desktop: {
    quitting: {
  ...
  settings: {
    ...
    hostSections: {
      ...
      knowledgeBases: {
        nav: "Knowledge bases",
        title: "Knowledge bases",
        openHub: "Open Knowledge bases",
        openHubHint: "Manage Knowledge bases from the Knowledge bases screen in the sidebar.",
        unsupported: "Update the host to use Knowledge bases.",
        connecting: "Connecting…",
        loading: "Loading Knowledge bases…",
        emptyTitle: "No Knowledge bases yet",
        emptyHint:
          "Create an empty Knowledge base or import a folder of text files / corpus package. One-shot import — disk is not watched.",
        importAction: "Import knowledge base",
        importTitle: "Import knowledge base",
        importSubmit: "Import",
        importHint:
          "One-shot import. The Knowledge base becomes the source of truth. Disk path is not watched.",
        importing: "Importing…",
        importOk: "Imported {{slug}}",
        importFailed: "Import failed",
        source: "Source",
        sourceFolder: "Folder",
        sourcePackage: "Package",
        sourceFolderHint: "Folder of .md / .mdx / .txt",
        sourcePackageHint: "Corpus package (manifest.json + pages/)",
        chooseFolder: "Choose folder…",
        pathOnHost: "Path on this host",
        useDesktop: "Use Desktop to choose a folder on this host.",
        remoteHostHint:
          "Import and export path pickers require Desktop with a local host. On this host, use: paseo kb import …",
        slug: "Slug",
        slugPlaceholder: "company-runbooks",
        slugInvalid: "Slug must match a-z, 0-9, hyphens (max 63).",
        name: "Name",
        nameOptional: "Optional",
        namePlaceholder: "Company runbooks",
        fromPathRequired: "Choose a folder first.",
        export: "Export",
        ...
        deleteBlockedTitle: "Still mounted",
        deleteBlockedMessage:
          "{{slug}} is still mounted on {{count}} workspace(s).\nUnmount it from those workspaces first.\n\n{{list}}",
        deleteBlockedUnknown: "Unmount it from those workspaces first.",
        deleteBlockedOk: "OK",
        actionsMenu: "Knowledge base actions for {{name}}",
        rowMeta: "{{slug}} · {{id}}",
        importedAt: "Imported {{date}}",
        embeddedAt: "Embedded {{date}}",
        embeddedNever: "Embedded never",
        embeddings: {
          title: "Embeddings",
          hint: "OpenAI-compatible embeddings for Knowledge base vector import and search on this host.",
          enabled: "Enabled",
          baseUrl: "Base URL",
          ...
          model: "Model",
          modelPlaceholder: "qwen3-embedding:0.6b",
          useOllama: "Use Ollama",
          save: "Save",
          test: "Test",
          testFailed: "Embeddings test failed",
          ollamaUnavailable: "Ollama was not detected on this host",
          ready: "Ready",
          error: "Error",
          unsupported: "Update the host to configure Knowledge base Embeddings.",
          configureHint:
            "Embeddings are disabled or misconfigured. Configure them in Settings → Host → Knowledge bases.",
        },
      },
      ...
      fastmcp: {
        ...
        runtimeStatus: "uv + Python + fastmcp",
        runtimeUnknown: "Not checked yet",
        ready: "Ready",
        notReady: "Not ready",
        ...
        install: "Install",
        pathHint:
          "Launchers live under $PASEO_HOME/mcp-cli/bin and are prepended to agent and Paseo terminal PATH. Shell rc is not modified.",
        serversTitle: "Servers",
        enable: "Enable {{name}}",
        oauthPasteHint:
          "Paste OAuth clientId / secret / redirectUri from Claude or Cursor MCP settings. First Test opens a browser on the daemon host.",
        clientId: "Client ID",
        clientIdPlaceholder: "Paste from Claude/Cursor",
        clientSecret: "Client secret",
        clientSecretPlaceholder: "Optional",
        redirectUri: "Redirect URI",
        redirectUriPlaceholder: "http://localhost:…/callback",
        save: "Save",
        test: "Test",
        saveErrorTitle: "Couldn’t save server",
        testErrorTitle: "Test failed",
        testOkTitle: "Test passed",
        testOkMessage: "CLI listed tools successfully.",

        authOptionalHint:
          "OAuth is optional for open endpoints. Leave Client ID empty for no-auth HTTP. Atlassian/Figma still need a pasted clientId.",
        url: "URL",
        name: "Name",
        transportHttp: "HTTP",
        ...
        args: "Args",
        argsPlaceholder: "-y @modelcontextprotocol/server-everything",
        argsHint: "Space-separated argv after the command. Env overlays come from JSON/import.",
        add: "Add",
        addTitle: "Add MCP server",
        addSubmit: "Add server",
        addHint:
          "HTTP remote URL only. Paste OAuth on the card after adding if the server needs it. Bearer/headers still unsupported.",
        addValidation: "Name and URL are required.",
        addValidationStdio: "Name and command are required.",
        addNameInvalid: "Name may only contain letters, numbers, ., _, -",
        jsonEdit: "JSON",
        jsonTitle: "Edit MCP JSON",
        jsonHint:
          "Shows the current servers as Claude/Cursor mcpServers JSON. Edit and Import to apply. Bearer/headers entries are skipped.",
        import: "Import",
        importOk: "Imported {{count}} server(s)",
        importLocal: "Import from host",
        importLocalOk: "Imported {{count}} from host configs",
        savedToast: "Saved",
        deletedToast: "Deleted",
        delete: "Delete",
        deleteTitle: "Delete server?",
        deleteMessage: "Remove {{name}} from FastMCP CLI?",
        testOkInline: "Test passed — tools listed.",
    ...
    host: {
      ...
      voiceTts: {
        title: "Модель голосового TTS",
        hint: "Синтез речи для голосового режима. Kokoro multilingual поддерживает китайский и английский",
        loading: "Загрузка моделей…",
        notInstalled: "Ещё не скачано",
        downloading: "Скачивание…",
        downloadingPercent: "Скачивание {{percent}}%",
        downloadingPercentWithSpeed: "Скачивание {{percent}}% · {{speed}}",
        downloadSpeed: "{{speed}}",
        download: "Скачать",
        apply: "Применить",
        applied: "Применено",
        ...
        available: "Доступно",
        unsupported: "Обновите хост, чтобы использовать это.",
        loadError: "Не удалось загрузить модели голосового TTS.",
        cloudProviderHint:
          "Голосовой TTS сейчас использует {{provider}}. Выбор модели ниже переключит TTS на локальный.",
        languagesMany: "{{count}} языков",
        models: {
          kokoroEn: "Kokoro (английский)",
          kokoroMultiLang: "Kokoro (китайский + английский)",
        },
        selectErrorTitle: "Не удалось переключить модель голосового TTS",
      },
      workspaces: {
  ...
  kanban: {
    ...
    sync: {
      succeeded: "Синхронизировано источников: {{count}}",
      failed: "Не удалось синхронизировать источники ({{count}}): {{names}}",
    },
    filters: {
      trigger: "Фильтры",
      searchLabel: "Поиск карточек",
      ...
      source: {
        ...
        gitlab: "GitLab",
        manual: "Вручную",
        clear: "Сбросить фильтр источника",
      },
      assignee: {
        label: "Исполнитель",
        all: "Все исполнители",
    ...
    columnForm: {
      renameTitle: "Переименовать столбец",
      titleLabel: "Название столбца",
      titlePlaceholder: "Название столбца",
    ...
    columnDelete: {
      ...
      message: 'Удалить "{{title}}"? Выберите, куда переместить его карточки.',
      destinationLabel: "Переместить карточки в",
      confirm: "Удалить",
    },
    hiddenColumns: {
      entry: "Скрытые столбцы",
      title: "Скрытые столбцы",
      empty: "Нет скрытых столбцов",
      restore: "Восстановить",
    },
    theme: {
      none: "По умолчанию",
    ...
    sources: {
      manageTitle: "Источники и подключения",
    ...
    sourceForm: {
      statusMapping: {
        ...
        createHint: "Сохраните источник, чтобы настроить сопоставление статусов.",
        projectKey: "Ключ проекта",
        projectKeyPlaceholder: "напр. SCIF",
        loadButton: "Загрузить статусы",
        loading: "Загрузка статусов…",
        loadError: "Не удалось загрузить статусы.",
        columnsLoadError: "Не удалось загрузить колонки.",
        empty: "Статусы не найдены.",
        columnLabel: "Колонка",
        columnPlaceholder: "Выберите колонку",
        autoOption: "Авто (по категории)",
      },
      ...
      gitlab: "GitLab",
      name: "Название",
      namePlaceholder: "Моя доска",
      query: "Запрос",
      queryPlaceholder: "JQL или фильтр MR",
      connection: "Подключение",
      connectionHint: "Подключение Jira/GitLab, используемое для аутентификации.",
      connectionNone: "Нет",
      baseUrl: "Переопределить базовый URL",
      baseUrlHint: "Необязательно. По умолчанию используется базовый URL подключения.",
    ...
    workflowRules: {
      ...
      labels: "Labels",
      labelsHint: "Comma-separated labels",
    ...
    connectionForm: {
      ...
      baseUrlPlaceholder: "https://ваш-сервер.example.com",
      token: "Токен доступа",
      tokenPlaceholder: "Вставьте личный токен доступа",
      oauthClientId: "ID клиента OAuth",
      oauthClientSecret: "Секрет клиента OAuth",
      authHint:
        "Вставьте токен доступа или зарегистрируйте приложение OAuth и нажмите «Подключить».",
      connectHint: "Сохраните подключение, затем откройте его снова для подключения.",
      save: "Сохранить",
      create: "Создать",
    },
    ...
    cardDetail: {
      ...
      loadError: "Не удалось загрузить детали карточки",
      unsupported: "Обновите хост, чтобы увидеть все детали карточки.",
      ...
      loadCommentsWithCount: "Загрузить комментарии ({{count}})",
      commentsLoadError: "Не удалось загрузить комментарии",
      unknownAuthor: "Неизвестно",
      dispatch: "Запустить через CLI",
      dispatchWorkspaceLabel: "Рабочая область",
      dispatchWorkspacePlaceholder: "Выберите рабочую область",
      dispatchNoWorkspaces: "Нет доступных рабочих областей — добавьте одну, чтобы включить --cwd.",
      dispatchPromptLabel: "Промпт",
      dispatchRun: "Запустить",
      dispatchRunNoWorkspace: "Выберите проект, чтобы запустить агента.",
      dispatchRunNoProvider: "Нет доступного провайдера",
      dispatchRunConfirmTitle: "Запустить агента?",
      dispatchRunConfirmProject: "Проект",
      dispatchRunConfirmWorktree: "Worktree",
      dispatchRunConfirmProvider: "Провайдер",
      dispatchRunConfirmPrompt: "Промпт",
      dispatchRunConfirmConfirm: "Запустить",
      dispatchRunSuccess: "Агент запущен",
      status: "Статус",
      replyPlaceholder: "Добавить комментарий…",
      replySend: "Отправить",
    },
    transitions: {
      pick: "Переместить в",
      loadError: "Не удалось загрузить переходы",
      empty: "Нет доступных переходов",
    },
  },
  workflows: {
    title: "Workflows",
    ...
    emptyDefinitions: "No workflow definitions yet",
    emptyBuiltins: "No built-in templates available",
    emptyRuns: "No workflow runs yet",
    builtin: "Built-in",
    createTitle: "Create workflow",
    editTitle: "Edit workflow",
    dispatchTitle: "Run workflow",
    dispatchTitleNamed: "Run {{name}}",
    project: "Project",
    projectPlaceholder: "Choose a repo to run in",
    projectEmpty: "No projects available",
    workspaceTitle: "Workspace name",
    workspaceTitlePlaceholder: "{{name}}",
    workspaceTitleEmojiLabel: "Workflow emoji prefix",
    workspaceTargetNew: "Новое рабочее пространство",
    workspaceTargetExisting: "Существующее рабочее пространство",
    workspaceTarget: "Рабочее пространство",
    workspacePickerPlaceholder: "Выберите рабочее пространство",
    workspacePickerEmpty: "На этом хосте пока нет рабочих пространств",
    browseCwd: "Browse",
    directoryPickerTitle: "Choose directory",
    directoryPickerSelect: "Use this folder",
    directoryPickerUp: "Parent folder",
    directoryPickerBrowse: "Folders",
    directoryPickerShortcuts: "Known projects",
    directoryPickerShortcutsPlaceholder: "Choose a known project…",
    directoryPickerShortcutsSearch: "Search projects…",
    directoryPickerShortcutsEmpty: "No known projects",
    directoryPickerSearchPlaceholder: "Search by path or name…",
    directoryPickerSearchResults: "Search results",
    directoryPickerSearching: "Searching…",
    directoryPickerNoMatches: "No matching directories",
    directoryPickerLoading: "Loading…",
    directoryPickerEmpty: "No subfolders here",
    ...
    runShowDebug: "Show technical details",
    runHideDebug: "Hide technical details",
    ...
    monitorAgentCount: "{{done}}/{{total}} agents",
    monitorAgentFallback: "agent #{{callId}}",
    monitorPhaseEmpty: "No agent calls in this phase yet",
    monitorStop: "Stop workflow",
    monitorHintSelect: "↑↓ select",
    monitorHintStop: "x stop workflow",
    monitorPause: "Pause",
    monitorResume: "Resume",
    monitorPaused: "PAUSED",
    monitorHintPause: "p pause",
    monitorHintResume: "p resume",
    runQueuedAt: "Queued {{time}}",
    runLogs: "Event log",
    runLogsEmpty: "waiting for events…",
    runLogsEmptyFinished: "no history for this run",
    runLogsLoading: "loading…",
    runLogsLive: "Live",
    ...
    runPauseFailed: "Couldn't pause the run",
    runResumeFromPauseFailed: "Couldn't resume the run",
    ...
    sourceHint: "This is the workflow script stored under definitions/.",
    ...
    authoring: {
      hint: "Opens an agent in your Paseo workflows folder so you can write a *.flow.js definition with chat — same idea as starting a new agent tab.",
      ...
      workspaceFailed: "Couldn't open the workflows workspace",
      agentTitle: "Create workflow",
    },
    actions: {
      create: "Create workflow",
      createBlank: "Create blank workflow",
      forkBuiltin: "Fork",
      startAuthoring: "Start agent",
      edit: "Edit",
      delete: "Delete",
      save: "Save",
      dispatch: "Dispatch",
  ...
  schedule: {
    ...
    list: {
      ...
      tryAgain: "Повторить",
      hostError: "{{serverName}}: не удалось загрузить расписания",
      newSchedule: "Новое расписание",
    },
    empty: {
      activeTitle: "Нет активных расписаний",
      activeDescription: "Расписания запускают агентов по графику.",
      seeDocs: "Смотреть документацию",
      endedTitle: "Нет завершённых расписаний",
    },
    form: {
      createTitle: "Новое расписание",
      ...
      name: {
        ...
        accessibility: "Название расписания",
      },
      prompt: {
        label: "Запрос",
        placeholder: "Что агент должен делать при каждом запуске?",
      },
      maxRuns: {
        label: "Макс. запусков",
        placeholder: "Без ограничения",
      ...
      mode: {
        ...
        empty: "Режимы не найдены",
        unavailable: "Для этой модели нет доступных режимов.",
      },
      isolation: {
        label: "Изоляция",
        placeholder: "Выберите изоляцию",
        empty: "Варианты изоляции не найдены",
        local: "Локально",
    ...
    cadence: {
      ...
      empty: "Варианты периодичности не найдены",
      ...
      every: {
        minuteOne: "Каждую {{count}} минуту",
        minuteMany: "Каждые {{count}} минут",
        hourOne: "Каждый {{count}} час",
        hourMany: "Каждые {{count}} часов",
        dayOne: "Каждый {{count}} день",
        dayMany: "Каждые {{count}} дней",
      },
      errorRequired: "Введите Cron-выражение",
    },
    meta: {
      untitledSchedule: "Расписание без названия",
      created: "Создано {{time}}",
      lastRun: "Последний запуск {{time}}",
      neverRun: "Ещё не запускалось",
      nextRun: "Следующий запуск {{next}}",
      nextRunSoon: "скоро",
      nextRunMinutes: "через {{count}} мин",
      nextRunHours: "через {{count}} ч",
      nextRunDays: "через {{count}} дн",
    },
    state: {
      active: "Активно",
      ...
      expired: "Истекло",
      finished: "Завершено",
      targetGone: "Цель удалена",
    },
    menu: {
      actions: "Действия с расписанием",
      editA11y: "Изменить расписание {{title}}",
