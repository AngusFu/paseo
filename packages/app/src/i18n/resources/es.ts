...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      localLlm: {
        ...
        hint: "Backend compatible con OpenAI en este host (por ejemplo Ollama)",
        baseUrl: "Base URL",
  ...
  kanban: {
    ...
    cardDetail: {
      ...
      summaryGenerating: "Resumiendo…",
      summaryFailed: "No se pudo generar un resumen.",
      summaryRegenerate: "Regenerar resumen",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        download: "Configura la IA local en los ajustes del host",
