  ...
  const handleValueChange = useCallback(
    (next: boolean) => {
      void patchConfig({ autoArchiveAfterMerge: next }).catch((error) => {
        ...
        Alert.alert(
          t("settings.host.workspaces.autoArchive.updateErrorTitle"),
    ...
    <View style={settingsStyles.card} testID="host-page-auto-archive-merged-workspaces-card">
      <View style={settingsStyles.row}>
        ...
        <Switch
          ...
          onValueChange={handleValueChange}
          accessibilityLabel={t("settings.host.workspaces.autoArchive.accessibilityLabel")}
  ...
  const handleValueChange = useCallback(
    (next: boolean) => {
      void patchConfig({ enableTerminalAgentHooks: next }).catch((error) => {
        ...
        Alert.alert(
          t("settings.host.terminalAgents.enableHooks.updateErrorTitle"),
          error instanceof Error ? error.message : String(error),
        );
      });
    },
