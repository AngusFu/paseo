...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        contextExpandUp: "上に展開",
        contextExpandDown: "下に展開",
        contextExpandAll: "非表示の行をすべて展開",
        contextHiddenLine: "非表示の {{count}} 行",
        contextHiddenLines: "非表示の {{count}} 行",
        contextExpandMore: "さらに行を表示",
        contextExpandFailed: "これ以上のコンテキストを読み込めませんでした。",
        refreshing: "更新中",
        refresh: "更新",
        ...
        worktreeMissing: "このワークスペースのワークツリーは存在しません。",
        worktreeMissingArchiveAction: "ワークスペースをアーカイブ",
        worktreeMissingArchiveFailed: "ワークスペースのアーカイブに失敗しました。",
        diffMode: "差分モード",
        uncommitted: "未コミット",
        committed: "コミット済み",
        branchUnknown: "不明",
        base: "ベース",
        baseReselectAction: "ベースブランチを選択…",
        baseReselectTitle: "ベースブランチを選択",
        baseReselectFailed: "ベースブランチの設定に失敗しました。",
        newFile: "新規",
        deletedFile: "削除済み",
        engine: "エンジン",
        engineGit: "Git",
        ...
        algorithm: "アルゴリズム",
        algorithmHistogram: "ヒストグラム",
        algorithmMyers: "Myers",
        algorithmPatience: "Patience",
        installDifftastic: "difftasticをインストール…",
        installingDifftastic: "difftasticをインストール中…",
        difftasticUnavailable: "このサーバーではdifftasticを利用できません",
        lineDiffBadge: "行単位diff",
        compareWithBranch: "ブランチと比較…",
        branchCompareTitle: "ブランチと比較",
        comparingWithBranch: "{{branch}} と比較",
        compareAgainstRef: "比較対象…",
        swapRefs: "入れ替え",
        onlyChangesOnBranch: "このブランチの変更のみ",
        fullDiff: "完全な差分",
        textSize: "文字サイズ",
        textSizeXs: "極小",
        textSizeSm: "小",
  ...
  settings: {
    ...
    host: {
      ...
      voiceTts: {
        title: "音声 TTS モデル",
        hint: "ボイスモードの読み上げ。Kokoro 多言語は中国語と英語に対応",
        loading: "モデルを読み込み中…",
        notInstalled: "未ダウンロード",
        downloading: "ダウンロード中…",
        downloadingPercent: "ダウンロード中 {{percent}}%",
        ...
        available: "利用可能",
        unsupported: "この機能を使うにはホストを更新してください。",
        loadError: "音声 TTS モデルを読み込めませんでした。",
        cloudProviderHint:
          "現在の音声 TTS は {{provider}} です。下のモデルを適用するとローカル TTS に切り替わります。",
        languagesMany: "{{count}} 言語",
        models: {
          kokoroEn: "Kokoro（英語）",
          kokoroMultiLang: "Kokoro（中英）",
        },
        selectErrorTitle: "音声 TTS モデルを切り替えできませんでした",
      },
      workspaces: {
  ...
  kanban: {
    ...
    columnDelete: {
      title: "列を削除",
      message: "「{{title}}」を削除しますか？カードの移動先を選択してください。",
      destinationLabel: "カードの移動先",
      confirm: "削除",
    },
    hiddenColumns: {
      entry: "非表示の列",
    ...
    sources: {
      ...
      lastSync: "最終同期: {{time}}",
      neverSynced: "未同期",
      syncFailed: "同期に失敗: {{error}}",
      confirmDelete: "「{{name}}」を削除しますか？この操作は取り消せません。",
    },
    sourceForm: {
      statusMapping: {
        title: "ステータスマッピング",
        createHint: "ソースを保存するとステータスマッピングを設定できます。",
        projectKey: "プロジェクトキー",
        projectKeyPlaceholder: "例: SCIF",
        loadButton: "ステータスを読み込む",
        loading: "ステータスを読み込み中…",
        loadError: "ステータスを読み込めませんでした。",
        columnsLoadError: "列を読み込めませんでした。",
        empty: "ステータスが見つかりません。",
        columnLabel: "列",
        columnPlaceholder: "列を選択",
        autoOption: "自動（カテゴリー別）",
      },
      ...
      gitlab: "GitLab",
      name: "名前",
      namePlaceholder: "マイボード",
      query: "クエリ",
      queryPlaceholder: "JQL または MR フィルター",
      connection: "接続",
      connectionHint: "認証に使用する Jira/GitLab 接続。",
      connectionNone: "なし",
      baseUrl: "ベース URL の上書き",
      baseUrlHint: "任意。既定では接続のベース URL を使用します。",
    ...
    connections: {
      ...
      connected: "接続済み",
      notConnected: "未接続",
      connectJira: "Jira に接続",
      connectGitlab: "GitLab に接続",
      delete: "削除",
      confirmDelete: "「{{name}}」を削除しますか？この操作は取り消せません。",
    },
    workflowRules: {
    ...
    connectionForm: {
      ...
      gitlab: "GitLab",
      name: "名前",
      namePlaceholder: "マイインスタンス",
      baseUrl: "ベース URL",
      baseUrlPlaceholder: "https://your-instance.example.com",
      token: "アクセストークン",
      tokenPlaceholder: "個人用アクセストークンを貼り付け",
      oauthClientId: "OAuth クライアント ID",
      oauthClientSecret: "OAuth クライアントシークレット",
      authHint: "アクセストークンを貼り付けるか、OAuth アプリを登録して「接続」を使用します。",
      connectHint: "接続を保存してから、開き直して接続します。",
      save: "保存",
      create: "作成",
    },
    ...
    cardDetail: {
      title: "カードの詳細",
      loadError: "カードの詳細を読み込めませんでした",
      unsupported: "カードの詳細をすべて表示するにはホストを更新してください。",
      assignee: "担当者",
      reporter: "報告者",
      priority: "優先度",
      created: "作成:",
      ...
      loadCommentsWithCount: "コメントを読み込む ({{count}})",
      commentsLoadError: "コメントを読み込めませんでした",
      unknownAuthor: "不明",
      dispatch: "CLI で実行",
      dispatchWorkspaceLabel: "ワークスペース",
      dispatchWorkspacePlaceholder: "ワークスペースを選択",
      dispatchNoWorkspaces: "利用可能なワークスペースがありません。追加すると --cwd が含まれます。",
      dispatchPromptLabel: "プロンプト",
      dispatchRun: "実行",
      dispatchRunNoWorkspace: "エージェントを実行するプロジェクトを選択してください。",
      dispatchRunNoProvider: "利用可能なプロバイダーがありません",
      dispatchRunConfirmTitle: "エージェントを実行しますか?",
      dispatchRunConfirmProject: "プロジェクト",
      dispatchRunConfirmWorktree: "ワークツリー",
      dispatchRunConfirmProvider: "プロバイダー",
  ...
  workflows: {
    ...
    workspaceTargetNew: "新しいワークスペース",
    workspaceTargetExisting: "既存のワークスペース",
    workspaceTarget: "ワークスペース",
    workspacePickerPlaceholder: "ワークスペースを選択",
    workspacePickerEmpty: "このホストにはまだワークスペースがありません",
    browseCwd: "Browse",
  ...
  schedule: {
    ...
    list: {
      loadError: "スケジュールを読み込めません",
      tryAgain: "再試行",
      hostError: "{{serverName}}：スケジュールを読み込めませんでした",
      newSchedule: "新しいスケジュール",
    },
    empty: {
      activeTitle: "有効なスケジュールはありません",
      activeDescription: "スケジュールはエージェントを一定間隔で実行します。",
      seeDocs: "ドキュメントを見る",
      endedTitle: "終了したスケジュールはありません",
    },
    form: {
      createTitle: "新しいスケジュール",
      editTitle: "スケジュールを編集",
      create: "スケジュールを作成",
      save: "変更を保存",
      ...
      name: {
        label: "名前",
        placeholder: "任意",
        accessibility: "スケジュール名",
      },
      prompt: {
        label: "プロンプト",
        placeholder: "実行ごとにエージェントに何をさせますか？",
      },
      maxRuns: {
        label: "最大実行回数",
        placeholder: "無制限",
      ...
      mode: {
        ...
        empty: "モードが見つかりません",
        unavailable: "このモデルで利用できるモードはありません。",
      },
      isolation: {
        label: "分離",
        placeholder: "分離を選択",
        empty: "分離オプションが見つかりません",
        local: "ローカル",
        worktree: "ワークツリー",
      },
    ...
    cadence: {
      ...
      every: {
        minuteOne: "{{count}} 分ごと",
        minuteMany: "{{count}} 分ごと",
        hourOne: "{{count}} 時間ごと",
        hourMany: "{{count}} 時間ごと",
        dayOne: "{{count}} 日ごと",
        dayMany: "{{count}} 日ごと",
      },
      errorRequired: "Cron 式を入力してください",
    },
    meta: {
      ...
      nextRun: "次回の実行 {{next}}",
      nextRunSoon: "まもなく",
      nextRunMinutes: "{{count}}分後",
      nextRunHours: "{{count}}時間後",
      nextRunDays: "{{count}}日後",
    },
    state: {
      active: "有効",
      paused: "一時停止中",
