export const en = {
  ...
  // Workspace mount surfaces (New Workspace picker + Mount knowledge bases sheet).
  // Host import/export/delete copy lives under settings.hostSections.knowledgeBases (D2).
  knowledgeBases: {
    mountKnowledgeBases: "Mount knowledge bases",
    optional: "optional",
