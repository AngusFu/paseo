...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      localLlm: {
        ...
        hint: "يعمل على هذا المضيف (تنزيل ~7 غيغابايت) ويشغّل ميزات الذكاء الاصطناعي المحلية مثل إنشاء cron باللغة الطبيعية.",
        download: "تنزيل",
  ...
  assistant: {
    add: "مساعد جديد",
    noAssistants: "لا يوجد مساعدون. أضف واحدًا لبدء المحادثة.",
    form: {
      createTitle: "مساعد جديد",
      editTitle: "تعديل المساعد",
      name: "الاسم",
      namePlaceholder: "مراجع الشيفرة",
      prompt: "التعليمات",
    ...
    empty: "تحدث مع {{name}}.",
    inputPlaceholder: "رسالة إلى {{name}}…",
    send: "إرسال",
    model: {
      required: "نزّل نموذج الذكاء الاصطناعي المحلي (~7 غيغابايت) لبدء المحادثة.",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        download: "تنزيل النموذج المحلي (~7 غيغابايت)",
        downloading: "جارٍ تنزيل النموذج… {{percent}}%",
