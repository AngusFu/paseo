...
function pickAppSettings(stored: StoredAppSettings): Partial<AppSettings> {
  ...
  pickExtendedAppSettings(stored, result);
  return result;
}

// Split out to keep pickAppSettings under the cyclomatic-complexity ceiling.
function pickExtendedAppSettings(stored: StoredAppSettings, result: Partial<AppSettings>): void {
