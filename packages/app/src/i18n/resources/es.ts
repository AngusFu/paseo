  ...
  settings: {
    ...
    hostSections: {
      ...
      fastmcp: {
        ...
        authOptionalHint:
          "OAuth is optional for open or DCR-capable endpoints. Atlassian/Figma still need a pasted clientId.",
        url: "URL",
        name: "Name",
        add: "Add",
        ...
        addHint:
          "HTTP remote URL only. Paste OAuth on the card after adding if the server needs it. stdio/bearer not supported yet.",
        addValidation: "Name and URL are required.",
        addNameInvalid: "Name may only contain letters, numbers, ., _, -",
        jsonEdit: "JSON",
        jsonTitle: "Edit MCP JSON",
        jsonHint:
          "Shows the current servers as Claude/Cursor mcpServers JSON. Edit and Import to apply. stdio and bearer/headers entries are skipped.",
        import: "Import",
