...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    deepseekHarness: {
      ...
      unavailable: "DeepSeek Harness 仅在 Desktop 应用中可用。",
      runtimeTitle: "运行时",
      statusLabel: "状态",
      packageHint: "安装到 Desktop 用户数据目录下的 @deepseek-ai/dsh。",
      version: "版本 {{version}}",
      port: "端口 {{port}}",
      launchTitle: "启动",
      startWithDesktop: "随 Desktop 启动",
      ...
      toast: {
        ...
        startFailed: "启动 DeepSeek Harness 失败",
        stopFailed: "停止 DeepSeek Harness 失败",
      },
    },
    integrations: {
      title: "集成",
