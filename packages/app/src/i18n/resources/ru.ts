  ...
  settings: {
    ...
    host: {
      ...
      localLlm: {
        ...
        hint: "Работает на этом хосте (загрузка ~7 ГБ) и обеспечивает локальные ИИ-функции, например генерацию cron из естественного языка.",
        download: "Скачать",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        download: "Скачать локальную модель (~7 ГБ)",
