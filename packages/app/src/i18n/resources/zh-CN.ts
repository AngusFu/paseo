...
export const zhCN: TranslationResources = {
  ...
  workflows: {
    ...
    workspaceTitleHint: "侧栏里显示的名字；前面的 emoji 固定不可删。",
    ...
    taskHint: "内置工作流（如 autopilot）需要一段明确的任务描述。",
    runDetailTitle: "运行详情",
    runTask: "任务：{{task}}",
    runNoTask: "未提供任务 / 参数",
    runOutcome: "结果",
    ...
    dispatchMode: "Mode",
    dispatchFast: "Fast",
    dispatchFastLabel: "快速模式",
    dispatchFastHint: "作为本次运行 agent() 的默认 Claude fast mode。",
    name: "名称",
