...
export const ar: TranslationResources = {
  ...
  kanban: {
    ...
    cardDetail: {
      ...
      summary: "ملخّص بالذكاء الاصطناعي",
      summaryGenerating: "جارٍ التلخيص…",
      summaryFailed: "تعذّر إنشاء ملخّص.",
      summaryRegenerate: "إعادة إنشاء الملخّص",
      comments: "التعليقات",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        download: "اضبط الذكاء الاصطناعي المحلي في إعدادات المضيف",
