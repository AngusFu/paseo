...
export const fr: TranslationResources = {
  ...
  promptOptimize: {
    action: "Optimiser le prompt",
    undo: "Annuler l’optimisation",
  },
  kanban: {
    title: "Kanban",
    ...
    cardDetail: {
      ...
      summary: "Résumé IA",
      summaryGenerating: "Résumé en cours…",
      summaryFailed: "Impossible de générer un résumé.",
      summaryRegenerate: "Régénérer le résumé",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        download: "Configurez l'IA locale dans les paramètres de l'hôte",
