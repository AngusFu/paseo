...
export const es: TranslationResources = {
  ...
  sessions: {
    ...
    searchEmpty: {
      title: "No hay sesiones coincidentes",
      onlyLoaded: "Solo se busca entre las {{count}} sesiones cargadas hasta ahora",
    },
    actions: {
      loadMore: "Cargar más",
    },
  ...
  workspace: {
    ...
    browser: {
      ...
      controls: {
        ...
        devToolsInline: "En línea",
        devToolsDetached: "Ventana separada",
    ...
    git: {
      ...
      diff: {
        ...
        contextExpandUp: "Expandir hacia arriba",
        contextExpandDown: "Expandir hacia abajo",
        contextExpandAll: "Expandir todas las líneas ocultas",
        contextHiddenLine: "{{count}} línea oculta",
        contextHiddenLines: "{{count}} líneas ocultas",
        contextExpandMore: "Mostrar más líneas",
        contextExpandFailed: "No se pudo cargar más contexto.",
        ...
        worktreeMissing: "El árbol de trabajo de este espacio de trabajo ya no existe.",
        worktreeMissingArchiveAction: "Archivar espacio de trabajo",
        worktreeMissingArchiveFailed: "No se pudo archivar el espacio de trabajo.",
        diffMode: "modo diferencial",
        uncommitted: "No comprometido",
        committed: "Comprometido",
        branchUnknown: "Desconocido",
        base: "base",
        baseReselectAction: "Elegir una rama base…",
        baseReselectTitle: "Seleccionar rama base",
        baseReselectFailed: "No se pudo establecer la rama base.",
        newFile: "Nuevo",
        ...
        algorithm: "Algoritmo",
        algorithmHistogram: "Histograma",
        algorithmMyers: "Myers",
        algorithmPatience: "Paciencia",
        installDifftastic: "Instalar difftastic…",
        installingDifftastic: "Instalando difftastic…",
        difftasticUnavailable: "Difftastic no está disponible en este servidor",
        lineDiffBadge: "diff de líneas",
        compareWithBranch: "Comparar con una rama…",
        branchCompareTitle: "Comparar con una rama",
        comparingWithBranch: "vs {{branch}}",
        compareAgainstRef: "Comparar contra…",
        swapRefs: "Intercambiar",
        onlyChangesOnBranch: "Solo cambios de esta rama",
      ...
      openInEditor: {
        ...
        codeServerStop: "Detener VS Code Web",
      },
      pr: {
        actions: {
          viewPullRequest: "Ver",
  ...
  settings: {
    ...
    host: {
      ...
      dictation: {
        ...
        hint: "Modelo de dictado del micrófono. SenseVoice cubre chino y cantonés",
      ...
      voiceTts: {
        title: "Modelo TTS de voz",
        hint: "Texto a voz para el modo de voz. Kokoro multilingüe cubre chino e inglés",
        loading: "Cargando modelos…",
        notInstalled: "Aún no descargado",
        downloading: "Descargando…",
        downloadingPercent: "Descargando {{percent}}%",
        ...
        available: "Disponible",
        unsupported: "Actualiza el host para usar esto.",
        loadError: "No se pudieron cargar los modelos TTS de voz.",
        cloudProviderHint:
          "El TTS de voz usa {{provider}}. Aplicar un modelo abajo vuelve al TTS local.",
        languagesMany: "{{count}} idiomas",
        models: {
          kokoroEn: "Kokoro (inglés)",
          kokoroMultiLang: "Kokoro (chino + inglés)",
        },
        selectErrorTitle: "No se pudo cambiar el modelo TTS de voz",
      },
      workspaces: {
  ...
  kanban: {
    ...
    jira: {
      ...
      groupByAssignee: "Agrupar por responsable",
    },
    overview: {
    ...
    columnForm: {
      ...
      titleLabel: "Nombre de la columna",
      titlePlaceholder: "Nombre de la columna",
      newColumnPlaceholder: "Nombre de la nueva columna",
    ...
    columnDelete: {
      ...
      message: 'Eliminar "{{title}}"? Elige adónde van sus tarjetas.',
      destinationLabel: "Mover tarjetas a",
      confirm: "Eliminar",
    },
    hiddenColumns: {
      entry: "Columnas ocultas",
      title: "Columnas ocultas",
      empty: "No hay columnas ocultas",
      restore: "Restaurar",
    },
    theme: {
      none: "Predeterminado",
    ...
    sources: {
      manageTitle: "Fuentes y conexiones",
      noConnection: "Sin conexión",
      title: "Fuentes",
      empty: "Aún no hay fuentes",
      add: "Añadir fuente",
      sync: "Sincronizar",
      delete: "Eliminar",
    ...
    sourceForm: {
      statusMapping: {
        ...
        createHint: "Guarda la fuente para configurar la asignación de estados.",
        projectKey: "Clave del proyecto",
        projectKeyPlaceholder: "p. ej. SCIF",
        loadButton: "Cargar estados",
        loading: "Cargando estados…",
        loadError: "No se pudieron cargar los estados.",
        columnsLoadError: "No se pudieron cargar las columnas.",
        empty: "No se encontraron estados.",
        columnLabel: "Columna",
        columnPlaceholder: "Seleccionar columna",
        autoOption: "Automático (por categoría)",
      },
      ...
      query: "Consulta",
      queryPlaceholder: "JQL o filtro de MR",
      connection: "Conexión",
      connectionHint: "La conexión de Jira/GitLab usada para autenticar.",
      connectionNone: "Ninguna",
      baseUrl: "Anular URL base",
      baseUrlHint: "Opcional. Por defecto, la URL base de la conexión.",
      baseUrlPlaceholder: "https://tu-instancia.example.com",
      pollEverySec: "Intervalo de sondeo (segundos)",
      enabled: "Habilitado",
      promptTemplate: "Plantilla de prompt",
      promptTemplateHint:
        "Opcional. Disponibles: {{title}} {{url}} {{description}} {{status}} {{assignee}} {{labels}} {{worktree}}, además de {{issueKey}}/{{contractBranch}} (Jira) o {{mrIid}} (GitLab).",
    ...
    connections: {
      ...
      connectJira: "Conectar Jira",
      connectGitlab: "Conectar GitLab",
      delete: "Eliminar",
      confirmDelete: '¿Eliminar "{{name}}"? Esta acción no se puede deshacer.',
    },
    workflowRules: {
    ...
    connectionForm: {
      ...
      tokenPlaceholder: "Pega un token de acceso personal",
      oauthClientId: "ID de cliente OAuth",
      oauthClientSecret: "Secreto de cliente OAuth",
      authHint: "Pega un token de acceso o registra una app OAuth y usa Conectar.",
      connectHint: "Guarda la conexión y vuelve a abrirla para conectar.",
      save: "Guardar",
      create: "Crear",
    },
    ...
    cardDetail: {
      ...
      loadError: "No se pudieron cargar los detalles de la tarjeta",
      unsupported: "Actualiza el host para ver los detalles completos de la tarjeta.",
      assignee: "Asignado a",
      reporter: "Informante",
      priority: "Prioridad",
      created: "Creado",
      ...
      dispatchRun: "Ejecutar",
      dispatchRunNoWorkspace: "Selecciona un proyecto para despachar un agente.",
      dispatchRunNoProvider: "No hay proveedor disponible",
      dispatchRunConfirmTitle: "¿Ejecutar agente?",
      dispatchRunConfirmProject: "Proyecto",
      dispatchRunConfirmWorktree: "Worktree",
      dispatchRunConfirmProvider: "Proveedor",
  ...
  workflows: {
    ...
    workspaceTargetNew: "Nuevo workspace",
    workspaceTargetExisting: "Workspace existente",
    workspaceTarget: "Workspace",
    workspacePickerPlaceholder: "Elige un workspace",
    workspacePickerEmpty: "Aún no hay workspaces en este host",
    browseCwd: "Browse",
  ...
  schedule: {
    ...
    filter: { active: "Activas", ended: "Finalizadas" },
    list: {
      loadError: "No se pudieron cargar las programaciones",
      tryAgain: "Reintentar",
      hostError: "{{serverName}}: No se pudieron cargar las programaciones",
      newSchedule: "Nueva programación",
    },
    empty: {
      activeTitle: "Sin programaciones activas",
      activeDescription: "Las programaciones ejecutan agentes con una cadencia.",
      seeDocs: "Ver documentación",
      endedTitle: "Sin programaciones finalizadas",
    },
    form: {
      ...
      name: {
        ...
        accessibility: "Nombre de la programación",
      },
      prompt: {
        label: "Instrucción",
        placeholder: "¿Qué debe hacer el agente en cada ejecución?",
      },
      maxRuns: {
      ...
      host: {
        label: "Host",
        placeholder: "Seleccionar host",
        empty: "No se encontraron hosts",
      },
      project: {
        label: "Proyecto",
        placeholder: "Seleccionar proyecto",
        empty: "No se encontraron proyectos",
        chooseHostFirst: "Elige un host primero.",
      ...
      mode: {
        ...
        empty: "No se encontraron modos",
        unavailable: "No hay modos disponibles para este modelo.",
      },
      isolation: {
        label: "Aislamiento",
        placeholder: "Seleccionar aislamiento",
        empty: "No se encontraron opciones de aislamiento",
        local: "Local",
        worktree: "Worktree",
      },
      archiveOnFinish: "Archivar al finalizar",
    },
    cadence: {
      label: "Cadencia",
      placeholder: "Seleccionar cadencia",
      empty: "No se encontraron cadencias",
      cronAccessibility: "Expresión Cron",
      presets: {
        everyMinute: "Cada minuto",
        everyHour: "Cada hora",
        daily9: "Diario 9:00",
        weekdays9: "Días laborables 9:00",
        mondays9: "Lunes 9:00",
        custom: "Cron personalizado",
      },
      describe: {
        everyHourAt: "Cada hora en el :{{minute}}",
      ...
      every: {
        minuteOne: "Cada {{count}} minuto",
        minuteMany: "Cada {{count}} minutos",
        hourOne: "Cada {{count}} hora",
        hourMany: "Cada {{count}} horas",
        dayOne: "Cada {{count}} día",
        dayMany: "Cada {{count}} días",
      },
      errorRequired: "Introduce una expresión cron",
    },
    meta: {
      untitledSchedule: "Programación sin título",
      created: "Creada {{time}}",
      lastRun: "Última ejecución {{time}}",
      neverRun: "Nunca ejecutada",
      nextRun: "Próxima ejecución {{next}}",
      nextRunSoon: "pronto",
      nextRunMinutes: "en {{count}} min",
      nextRunHours: "en {{count}} h",
      nextRunDays: "en {{count}} d",
    },
    state: {
      active: "Activa",
      paused: "En pausa",
      expired: "Expirada",
      finished: "Finalizada",
      targetGone: "Objetivo eliminado",
    },
    menu: {
      actions: "Acciones de la programación",
      editA11y: "Editar programación {{title}}",
      edit: "Editar programación",
      resume: "Reanudar programación",
      resuming: "Reanudando...",
