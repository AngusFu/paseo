...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        contextExpandUp: "Expandir para cima",
        contextExpandDown: "Expandir para baixo",
        contextExpandAll: "Expandir todas as linhas ocultas",
        contextHiddenLine: "{{count}} linha oculta",
        contextHiddenLines: "{{count}} linhas ocultas",
        contextExpandMore: "Mostrar mais linhas",
        contextExpandFailed: "Não foi possível carregar mais contexto.",
        ...
        worktreeMissing: "A worktree deste espaço de trabalho não existe mais.",
        worktreeMissingArchiveAction: "Arquivar espaço de trabalho",
        worktreeMissingArchiveFailed: "Falha ao arquivar o espaço de trabalho.",
        diffMode: "Modo de diff",
        uncommitted: "Sem commit",
        committed: "Com commit",
        branchUnknown: "Desconhecido",
        base: "base",
        baseReselectAction: "Escolher uma ramificação base…",
        baseReselectTitle: "Selecionar ramificação base",
        baseReselectFailed: "Falha ao definir a ramificação base.",
        newFile: "Novo",
        ...
        algorithmPatience: "Paciência",
        installDifftastic: "Instalar difftastic…",
        installingDifftastic: "Instalando difftastic…",
        difftasticUnavailable: "Difftastic não está disponível neste servidor",
        lineDiffBadge: "diff de linhas",
        compareWithBranch: "Comparar com uma branch…",
        branchCompareTitle: "Comparar com uma branch",
        comparingWithBranch: "vs {{branch}}",
        compareAgainstRef: "Comparar com…",
        swapRefs: "Inverter",
        onlyChangesOnBranch: "Apenas alterações desta branch",
  ...
  settings: {
    ...
    host: {
      ...
      voiceTts: {
        ...
        hint: "Texto para fala no modo de voz. Kokoro multilíngue cobre chinês e inglês",
        loading: "Carregando modelos…",
        notInstalled: "Ainda não baixado",
        downloading: "Baixando…",
        downloadingPercent: "Baixando {{percent}}%",
        downloadingPercentWithSpeed: "Baixando {{percent}}% · {{speed}}",
        downloadSpeed: "{{speed}}",
        download: "Baixar",
        apply: "Aplicar",
        applied: "Aplicado",
        ...
        available: "Disponível",
        unsupported: "Atualize o host para usar isto.",
        loadError: "Não foi possível carregar os modelos TTS de voz.",
        cloudProviderHint:
          "O TTS de voz está usando {{provider}}. Aplicar um modelo abaixo volta para TTS local.",
        languagesMany: "{{count}} idiomas",
        models: {
          kokoroEn: "Kokoro (inglês)",
          kokoroMultiLang: "Kokoro (chinês + inglês)",
        },
        selectErrorTitle: "Não foi possível trocar o modelo TTS de voz",
      },
      workspaces: {
  ...
  kanban: {
    ...
    sync: {
      succeeded: "{{count}} fontes sincronizadas",
      failed: "Falha ao sincronizar {{count}} fontes: {{names}}",
    },
    filters: {
      trigger: "Filtros",
      searchLabel: "Buscar cartões",
    ...
    columnForm: {
      ...
      titleLabel: "Nome da coluna",
      titlePlaceholder: "Nome da coluna",
    ...
    columnDelete: {
      ...
      message: 'Excluir "{{title}}"? Escolha para onde seus cartões vão.',
      destinationLabel: "Mover cartões para",
      confirm: "Excluir",
    },
    hiddenColumns: {
      entry: "Colunas ocultas",
      title: "Colunas ocultas",
      empty: "Nenhuma coluna oculta",
      restore: "Restaurar",
    },
    theme: {
      none: "Padrão",
    ...
    sources: {
      manageTitle: "Fontes e conexões",
      noConnection: "Sem conexão",
      title: "Fontes",
      empty: "Ainda não há fontes",
      add: "Adicionar fonte",
      sync: "Sincronizar",
      delete: "Excluir",
    ...
    sourceForm: {
      statusMapping: {
        ...
        createHint: "Salve a fonte para configurar o mapeamento de status.",
        projectKey: "Chave do projeto",
        projectKeyPlaceholder: "ex.: SCIF",
        loadButton: "Carregar status",
        loading: "Carregando status…",
        loadError: "Não foi possível carregar os status.",
        columnsLoadError: "Não foi possível carregar as colunas.",
        empty: "Nenhum status encontrado.",
        columnLabel: "Coluna",
        columnPlaceholder: "Selecionar coluna",
        autoOption: "Automático (por categoria)",
      },
      queryHint: "Jira = atribuídas a mim e não resolvidas; GitLab = MRs aguardando minha revisão.",
      createTitle: "Nova fonte",
      editTitle: "Editar fonte",
      tabSource: "Fonte",
      tabWorkflowRules: "Regras de workflow",
      kind: "Tipo",
      jira: "Jira",
      gitlab: "GitLab",
      name: "Nome",
      namePlaceholder: "Meu quadro",
      query: "Consulta",
      queryPlaceholder: "JQL ou filtro de MR",
      connection: "Conexão",
      connectionHint: "A conexão Jira/GitLab usada para autenticar.",
      connectionNone: "Nenhuma",
      baseUrl: "Substituir URL base",
      baseUrlHint: "Opcional. Usa a URL base da conexão por padrão.",
    ...
    connectionForm: {
      ...
      tokenPlaceholder: "Cole um token de acesso pessoal",
      oauthClientId: "ID do cliente OAuth",
      oauthClientSecret: "Segredo do cliente OAuth",
      authHint: "Cole um token de acesso ou registre um app OAuth e use Conectar.",
      connectHint: "Salve a conexão e reabra-a para conectar.",
      save: "Salvar",
      create: "Criar",
    },
    ...
    cardDetail: {
      ...
      loadError: "Não foi possível carregar os detalhes do cartão",
      unsupported: "Atualize o host para ver todos os detalhes do cartão.",
      ...
      status: "Status",
      replyPlaceholder: "Adicionar um comentário…",
      replySend: "Enviar",
    },
    transitions: {
      pick: "Mover para",
      loadError: "Não foi possível carregar as transições",
      empty: "Nenhuma transição disponível",
    },
  },
  workflows: {
    title: "Workflows",
    ...
    workspaceTargetNew: "Novo workspace",
    workspaceTargetExisting: "Workspace existente",
    workspaceTarget: "Workspace",
    workspacePickerPlaceholder: "Escolha um workspace",
    workspacePickerEmpty: "Ainda não há workspaces neste host",
    browseCwd: "Browse",
  ...
  schedule: {
    ...
    list: {
      ...
      tryAgain: "Tentar novamente",
      hostError: "{{serverName}}: Não foi possível carregar os agendamentos",
      newSchedule: "Novo agendamento",
    },
    empty: {
      activeTitle: "Nenhum agendamento ativo",
      activeDescription: "Agendamentos executam agentes em uma cadência.",
      seeDocs: "Ver documentação",
      endedTitle: "Nenhum agendamento encerrado",
    },
    form: {
      ...
      name: {
        ...
        accessibility: "Nome do agendamento",
      },
      prompt: {
        label: "Prompt",
      ...
      maxRuns: {
        label: "Execuções máximas",
        placeholder: "Ilimitado",
      },
      host: {
        label: "Host",
        placeholder: "Selecionar host",
        empty: "Nenhum host encontrado",
      },
      project: {
        label: "Projeto",
      ...
      mode: {
        ...
        empty: "Nenhum modo encontrado",
        unavailable: "Nenhum modo está disponível para este modelo.",
      },
      isolation: {
        label: "Isolamento",
        placeholder: "Selecionar isolamento",
        empty: "Nenhuma opção de isolamento encontrada",
        local: "Local",
        worktree: "Worktree",
      },
    ...
    cadence: {
      label: "Cadência",
      placeholder: "Selecionar cadência",
      empty: "Nenhuma cadência encontrada",
      cronAccessibility: "Expressão Cron",
      presets: {
        everyMinute: "A cada minuto",
        everyHour: "A cada hora",
        daily9: "Diariamente às 9:00",
      ...
      every: {
        minuteOne: "A cada {{count}} minuto",
        minuteMany: "A cada {{count}} minutos",
        hourOne: "A cada {{count}} hora",
        hourMany: "A cada {{count}} horas",
        dayOne: "A cada {{count}} dia",
        dayMany: "A cada {{count}} dias",
      },
      errorRequired: "Insira uma expressão cron",
    },
    meta: {
      untitledSchedule: "Agendamento sem título",
      created: "Criado {{time}}",
      lastRun: "Última execução {{time}}",
      neverRun: "Nunca executado",
      nextRun: "Próxima execução {{next}}",
      nextRunSoon: "em breve",
      nextRunMinutes: "em {{count}} min",
      nextRunHours: "em {{count}} h",
      nextRunDays: "em {{count}} d",
    },
    state: {
      active: "Ativo",
      paused: "Pausado",
      expired: "Expirado",
      finished: "Concluído",
      targetGone: "Alvo removido",
    },
    menu: {
      actions: "Ações do agendamento",
      editA11y: "Editar agendamento {{title}}",
