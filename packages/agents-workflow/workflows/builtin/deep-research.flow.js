...
export const meta = {
  ...
  phases: [
    ...
    { title: "Search", detail: "5 parallel search agents, one per angle" },
...
const SEARCH_PROMPT = (angle) =>
  ...
  angle.query +
  "`\n\n" +
  "## Task\nUse available search tools (e.g., web search, MCP search servers, or local indices) with the query above (or a refined version). Return the top 4-6 most relevant results.\n" +
...
const FETCH_PROMPT = (source, angle) =>
  ...
  angle +
  " search\n\n" +
  "## Task\n1. Use available content retrieval tools (e.g., web fetch, MCP fetch servers, or local caches) to retrieve the page content.\n" +
...
const VERIFY_PROMPT = (claim, v) =>
  ...
  "2. Search for contradicting evidence (use available search tools) — does any credible source dispute or heavily qualify this?\n" +
