  ...
  settings: {
    ...
    hostSections: {
      ...
      fastmcp: {
        ...
        authOptionalHint:
          "开放端点或支持 DCR 的服务可不填 OAuth。Atlassian/Figma 仍需粘贴 clientId。",
        url: "URL",
        name: "名称",
        add: "添加",
        addTitle: "添加 MCP 服务器",
        addSubmit: "添加",
        addHint: "仅支持 HTTP remote URL。需要 OAuth 时在卡片上再填。stdio / bearer 暂不支持。",
        addValidation: "名称和 URL 必填。",
        addNameInvalid: "名称只能包含字母、数字、.、_、-",
        jsonEdit: "JSON",
        jsonTitle: "编辑 MCP JSON",
        jsonHint:
          "打开时显示当前服务器（Claude/Cursor mcpServers 格式）。改完点导入生效。stdio / bearer / headers 会被跳过。",
        import: "导入",
