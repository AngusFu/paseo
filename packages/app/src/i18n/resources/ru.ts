...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    deepseekHarness: {
      ...
      unavailable: "DeepSeek Harness is only available in the desktop app.",
      runtimeTitle: "Runtime",
      statusLabel: "Status",
      packageHint: "Installs @deepseek-ai/dsh under the desktop user data directory.",
      version: "Version {{version}}",
      port: "Port {{port}}",
      launchTitle: "Launch",
      startWithDesktop: "Start with Desktop",
      ...
      toast: {
        ...
        startFailed: "Failed to start DeepSeek Harness",
        stopFailed: "Failed to stop DeepSeek Harness",
      },
    },
    integrations: {
      title: "Интеграции",
