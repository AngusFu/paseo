...
| [docs/forms.md](docs/forms.md)                                                 | Form architecture — non-React form model, form kit, load-state gating, sheet footer actions (Delete left); schedule form golden example |
...
| [docs/kanban.md](docs/kanban.md)                                               | Global Kanban board, sync sources, source-level workflow auto-trigger rules                                                             |
| [docs/workflow.md](docs/workflow.md)                                           | Agents-workflow SDK, definitions/runs storage, dispatch defaults (provider/model/effort/mode/fast), concurrency queue, RPCs             |
...
| [docs/virtual-fs-hooks.md](docs/virtual-fs-hooks.md)                           | Virtual docs via hooks — router + SQLite content plane; daemon KBs + workspace mounts; coexistence with activity hooks                  |
| [docs/knowledge-bases-product.md](docs/knowledge-bases-product.md)             | Product source of truth for the dedicated Knowledge bases hub: create, detail, search, edit, mounts relationship                        |
| [docs/knowledge-bases-v1-acceptance.md](docs/knowledge-bases-v1-acceptance.md) | P0–P2 hand-test checklist against dev daemon 6768 + Expo 8081; mount CTA + Settings `serverId` closeout                                 |
| [docs/knowledge-bases-desktop.md](docs/knowledge-bases-desktop.md)             | Desktop KB UX design — Host manage, New Workspace mounts, workspace mount sheet, agent empty `/paseo-vfs`; RPC gaps                     |
