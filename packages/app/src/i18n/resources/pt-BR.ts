...
export const ptBR: TranslationResources = {
  ...
  kanban: {
    ...
    cardDetail: {
      ...
      summaryGenerating: "Resumindo…",
      summaryFailed: "Não foi possível gerar um resumo.",
      summaryRegenerate: "Gerar resumo novamente",
  ...
  schedule: {
    ...
    cadence: {
      ...
      ai: {
        ...
        generate: "Gerar",
        generating: "Gerando…",
        download: "Configure a IA local nas configurações do host",
